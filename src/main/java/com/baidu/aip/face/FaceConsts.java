...
public class FaceConsts {
    ...
    static final String  VERIFY = "https://aip.baidubce.com/rest/2.0/face/v4/mingjing/verify";

    static final String FACE_MATCH_V4 = "https://aip.baidubce.com/rest/2.0/face/v4/mingjing/match";

    static final String ONLINE_PICTURE_LIVE_V4 =
